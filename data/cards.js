...
export const intervals = [
  ...
  3 * 86400,
  5 * 86400,
  8 * 86400, // 8j // In seconds : 691 200
  13 * 86400, // 13j // In seconds : 1 123 200
  21 * 86400, // 21j // In seconds : 1 814 400
  34 * 24 * 60 * 60, // 34 jours // 1 mois // In seconds : 2 950 400
  55 * 24 * 60 * 60, // 55 jours = 1 mois et demi // In seconds : 47304000
  90 * 24 * 60 * 60, // 90 jours // In seconds : 7776000
  145 * 24 * 60 * 60,
  235 * 24 * 60 * 60,
  370 * 24 * 60 * 60, //
];
